...
export const siteConfig: SiteConfig = {
	title: "枪宴のBlog",
	subtitle: "INJT.TOP",
	siteURL: "https://injt.top/", // 请替换为你的站点URL，以斜杠结尾
	...
	banner: {
		...
		carousel: {
			enable: trur, // 为 true 时：为多张图片启用轮播。为 false 时：从数组中随机显示一张图片
		...
		homeText: {
			...
			subtitle: [
				...
				"时间在时间里 耐心是生活的关键 找不到答案的时候出去走走",
                "经济与年龄无关 但优秀与努力有关",
                "你想去很多地方 可一个人不敢",
                "是话变少了 还是分享的人不是我了",
                "总会有不期而遇的温暖和生生不息的希望",
                "生活找不到前途 夜晚盖不住心事 我也总问自己烂透的是我还是生活",
                "一个人在无可奈何的时候 除了沉默也只剩微笑了",
                "不图事事圆满 只图事事顺心",
                "我不是很好 但对你我愿意付出所有的真心",
                "人总是这样 从不记万般好 只记一时错",
                "我承认我想你了 每时 每刻 每分 每秒都在想你",
                "明明两手空空 为何心事重重",
                "此刻 来年都幸福",
                "少年别认输 天黑之后就是日出",
                "远山的少年心无疆 山风为伴梦悠扬",
                "如果有一天 我不再频繁的更新动态 我想那时候我一定很幸福",
                "如果离别是尽头 那相遇的意义是什么",
                "我知道自己状态不对了 但我没招了",
                "没有大彻大悟 只有边走边悟",
			],
